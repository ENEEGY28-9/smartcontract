# TAO COLLECTION ROOMS TRONG POCKETBASE
# Su dung thong tin admin da co san
...
Write-Host "TAO COLLECTION ROOMS TRONG POCKETBASE" -ForegroundColor Cyan
Write-Host "=========================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "  PocketBase URL: $PocketBaseUrl" -ForegroundColor White
Write-Host ""
...
try {
    ...
    Write-Host "  - Kiem tra lai thong tin admin" -ForegroundColor Yellow
    exit 1
}
...
try {
    ...
    Write-Host "  - Loi tao collection: $($_.Exception.Message)" -ForegroundColor Red
...
Write-Host ""
Write-Host "Collection rooms da duoc tao/cap nhat thanh cong!" -ForegroundColor Green
