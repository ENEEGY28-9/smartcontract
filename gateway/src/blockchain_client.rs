...
pub mod blockchain {
    ...
    impl BlockchainServiceClient<Channel> {
        ...
        pub async fn mint_token_on_eat_particle(
            ...
            println!("🔄 [BLOCKCHAIN] Minting tokens for player {} at location ({}, {})",
...
impl BlockchainClient {
    ...
    pub async fn mint_token_on_eat_particle(
        ...
        if result.success {
            tracing::info!("✅ [REAL BLOCKCHAIN] Minted token with TX: {}", result.transaction_signature);
    ...
    pub async fn transfer_tokens(
        ...
        if result.success {
            tracing::info!("✅ [REAL BLOCKCHAIN] Transferred tokens with TX: {}", result.transaction_signature);
            Ok(result.transaction_signature)
        } else {
    ...
    pub async fn get_player_balance(&self, player_wallet: &str) -> Result<u64> {
        ...
        tracing::info!("💰 [REAL BLOCKCHAIN] Player {} balance: {}", player_wallet, result.balance);
        Ok(result.balance)
    }
    ...
    pub async fn emit_token_update(
        ...
        tracing::info!("📡 [REAL BLOCKCHAIN] Emitted token update for user {}: minted={}", user_id, amount_minted);
        Ok(())
    }
    ...
    pub async fn transfer_from_game_pool(
        ...
        tracing::info!("🎮 [SIMULATED] Transferred {} tokens from game pool to {} at location ({}, {})", amount, player_wallet, particle_location.0, particle_location.1);
